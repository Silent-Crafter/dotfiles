...
for keymap in emacs vicmd viins; do
  ...
  bindkey -M $keymap "^[h" dirhistory_zle_dirhistory_back    # probably everything
  ...
  bindkey -M $keymap "^[l" dirhistory_zle_dirhistory_future    # probably everything
...
for keymap in emacs vicmd viins; do
  ...
  bindkey -M $keymap "^[k" dirhistory_zle_dirhistory_up    # probably everything
  ...
  bindkey -M $keymap "^[j" dirhistory_zle_dirhistory_down    # probably everything
